...
export CUDA_VISIBLE_DEVICES=GPU-74b9b73f-c405-55bc-bf76-f8aa85d1e7fe,GPU-000b6236-3632-a001-9667-1f02cbb61c8b
export TORCH_EXTENSIONS_DIR="$ROOT/cache/torch_extensions"
runtime_tmp=$(mktemp -d /tmp/huayiming-sparseworld-dual.XXXXXX)
...
print('DUAL_LAUNCH_PREFLIGHT_PASSED',work,flush=True)
PY
python -m torch.distributed.run --standalone --nnodes=1 --nproc_per_node=2 train.py --config "$1"
