_base_ = './sw-radar-forecast-belief.py'
work_dir = '/storage/data/metaiot_data/huayiming/SparseWorld/work_dirs/radar_forecast_belief_smoke_seed0'
max_iters = 24
...
custom_hooks = [dict(type='FiniteTrainingLossHook', priority='HIGH'),
                dict(type='RadarLearningAuditHook', components=True, interval=4),
